...
/// the motion blur.
/// </summary>
public class MotionBlur : RayTracingTutorial
{
  /// <summary>
  ...
  public MotionBlur(RayTracingTutorialAsset asset) : base(asset)
  {
  }
    ...
    try
    {
      if (_frameIndex < 1000)
      {
        using (new ProfilingSample(cmd, "RayTracing"))
        {
          ...
          cmd.DispatchRays(_shader, "MotionBlurGenShader", (uint) outputTarget.rt.width,
